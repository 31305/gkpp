...
d=False
ps=[
        ['https://w.wiki/FqvQ',[[71,2,60,56,3,49,4,69,2,46,3,77],[56,1,66,46,5,44,3,77,49,4,69,2,46,3,77],[66,44,2,43,3,77,49,4,69,2,46,3,77]],3],
        ...
        ['https://w.wiki/Fqw4',[[47,2,51,3,61,37,46,19,48,1,74,5,70,51,3,44,48,1,66,7],[47,2,51,3,61,1,76,46,19,48,1,74,5,77,51,3,44,48,1,70,66,7],
                                [47,2,51,3,61,1,76,46,19,48,1,74,42,51,3,44,48,1,66,1,77]],3],
        ...
        ['https://w.wiki/FrmC',[[47,43,31,70,41],[53,20,69,44,42],[51,1,71,38,66,42]],2],
        ...
        ['https://w.wiki/FrkF',[[51,4,46,31,44,11],[70,1,44,75,1,68,5],[53,2,55,53,6]],3],
        ['https://w.wiki/FrkN',[[70,7,47,5,61,3,70,1,77],[72,1,45,5,47,3,70,1,77],[75,19,53,5,68,3,70,1,77]],1],
        ['https://w.wiki/FrkV',[[51,37,61,1,44,2,75],[46,1,45,75,10,51,2,77],[49,1,44,71,2,51,21,66,1,75]],2],
        ['https://w.wiki/Frkd',[[66,44,8,51,3,51,13,66],[68,46,8,51,3,51,13,66],[56,2,66,15,48,51,1,51,13,66]],2],
        ['https://w.wiki/Fsfy',[[71,44,5,66,9,51,4],[70,10,45,37,66,71,1,45,2,77],[51,14,75,15,68,1,75]],3],
        ['https://w.wiki/Frkd',[[58,20,75,74,3,65,1,75],[53,2,44,58,3,70,1,75],[52,5,68,3,70,1,75]],1],
    ]
knns=3
def pk():
    ...
    for k in range(0,len(ps)):
        if os.path.isfile('ds/'+str(k+1).zfill(knns)+'.jpg') or ps[k][0]=='':continue
        dn=ps[k][0]
        dn='"'+dn+'"'
...
def dd(k):
    from os import system
    system('explorer.exe ds\\\\'+str(k+1).zfill(knns)+'.jpg')
def tpk():
    import sys,p
    pk=0
    global k,ngg
